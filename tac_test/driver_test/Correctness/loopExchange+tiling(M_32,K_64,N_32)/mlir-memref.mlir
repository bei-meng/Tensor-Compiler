    ...
    scf.for %arg3 = %c0 to %c2048 step %c64 {
      scf.for %arg4 = %c0 to %c2048 step %c64 {
        scf.for %arg5 = %c0 to %c2048 step %c64 {
          %subview = memref.subview %arg0[%arg3, %arg4] [64, 64] [1, 1] : memref<2048x2048xf32, strided<[?, ?], offset: ?>> to memref<64x64xf32, strided<[?, ?], offset: ?>> loc(#loc1)
          %subview_1 = memref.subview %arg1[%arg4, %arg5] [64, 64] [1, 1] : memref<2048x2048xf32, strided<[?, ?], offset: ?>> to memref<64x64xf32, strided<[?, ?], offset: ?>> loc(#loc1)
          %subview_2 = memref.subview %alloc_0[%arg3, %arg5] [64, 64] [1, 1] : memref<2048x2048xf32> to memref<64x64xf32, strided<[2048, 1], offset: ?>> loc(#loc1)
          scf.for %arg6 = %c0 to %c64 step %c1 {
            scf.for %arg7 = %c0 to %c64 step %c1 {
              scf.for %arg8 = %c0 to %c64 step %c1 {
                %0 = memref.load %subview[%arg6, %arg7] : memref<64x64xf32, strided<[?, ?], offset: ?>> loc(#loc1)
                %1 = memref.load %subview_1[%arg7, %arg8] : memref<64x64xf32, strided<[?, ?], offset: ?>> loc(#loc1)
                %2 = memref.load %subview_2[%arg6, %arg8] : memref<64x64xf32, strided<[2048, 1], offset: ?>> loc(#loc1)
                %3 = arith.mulf %0, %1 : f32 loc(#loc1)
                %4 = arith.addf %2, %3 : f32 loc(#loc1)
                memref.store %4, %subview_2[%arg6, %arg8] : memref<64x64xf32, strided<[2048, 1], offset: ?>> loc(#loc1)
              } loc(#loc1)
            } loc(#loc1)
          } loc(#loc1)
        } loc(#loc1)
