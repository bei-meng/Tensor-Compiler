...
define { ptr, ptr, i64, [2 x i64], [2 x i64] } @main(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, ptr %7, ptr %8, i64 %9, i64 %10, i64 %11, i64 %12, i64 %13) {
  ...
  %29 = call ptr @malloc(i64 4194368)
  ...
  %38 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %37, i64 1024, 3, 0
  %39 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %38, i64 1024, 3, 1
  %40 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %39, i64 1024, 4, 0
...
57:                                               ; preds = %42
  %58 = call ptr @malloc(i64 2097216)
  %59 = ptrtoint ptr %58 to i64
  %60 = add i64 %59, 63
  %61 = urem i64 %60, 64
  %62 = sub i64 %60, %61
  %63 = inttoptr i64 %62 to ptr
  %64 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } poison, ptr %58, 0
  %65 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %64, ptr %63, 1
  %66 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %65, i64 0, 2
  %67 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %66, i64 1024, 3, 0
  %68 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %67, i64 512, 3, 1
  %69 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %68, i64 512, 4, 0
  %70 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %69, i64 1, 4, 1
  br label %71

71:                                               ; preds = %94, %57
  %72 = phi i64 [ 0, %57 ], [ %95, %94 ]
...
108:                                              ; preds = %105
  ...
  %128 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %127, i64 32, 3, 0
  %129 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %128, i64 %117, 4, 0
  %130 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %129, i64 32, 3, 1
  %131 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %130, i64 %118, 4, 1
  %132 = mul nsw i64 %102, 512
  %133 = add i64 %132, %106
  %134 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %70, 0
  %135 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %70, 1
  ...
  %139 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %138, i64 32, 3, 0
  %140 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %139, i64 512, 4, 0
  %141 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %140, i64 32, 3, 1
  %142 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %141, i64 1, 4, 1
  %143 = mul nsw i64 %98, 1024
  %144 = add i64 %143, %102
  %145 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %41, 0
  %146 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %41, 1
  ...
  %151 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %150, i64 1024, 4, 0
