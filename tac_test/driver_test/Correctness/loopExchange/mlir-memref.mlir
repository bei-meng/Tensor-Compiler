  ...
  func.func @main(%arg0: memref<2048x2048xf32, strided<[?, ?], offset: ?>> loc(unknown), %arg1: memref<2048x2048xf32, strided<[?, ?], offset: ?>> loc(unknown), %arg2: memref<2048x2048xf32, strided<[?, ?], offset: ?>> loc(unknown)) -> memref<2048x2048xf32> attributes {llvm.emit_c_interface} {
    ...
    scf.for %arg3 = %c0 to %c2048 step %c1 {
      scf.for %arg4 = %c0 to %c2048 step %c1 {
        memref.store %cst, %alloc[%arg3, %arg4] : memref<2048x2048xf32> loc(#loc1)
      } loc(#loc1)
    } loc(#loc1)
    scf.for %arg3 = %c0 to %c2048 step %c1 {
      scf.for %arg4 = %c0 to %c2048 step %c1 {
        scf.for %arg5 = %c0 to %c2048 step %c1 {
          %0 = memref.load %arg0[%arg3, %arg4] : memref<2048x2048xf32, strided<[?, ?], offset: ?>> loc(#loc1)
          %1 = memref.load %arg1[%arg4, %arg5] : memref<2048x2048xf32, strided<[?, ?], offset: ?>> loc(#loc1)
          %2 = memref.load %alloc[%arg3, %arg5] : memref<2048x2048xf32> loc(#loc1)
          %3 = arith.mulf %0, %1 : f32 loc(#loc1)
          %4 = arith.addf %2, %3 : f32 loc(#loc1)
          memref.store %4, %alloc[%arg3, %arg5] : memref<2048x2048xf32> loc(#loc1)
        } loc(#loc1)
      } loc(#loc1)
    } loc(#loc1)
    scf.for %arg3 = %c0 to %c2048 step %c1 {
      scf.for %arg4 = %c0 to %c2048 step %c1 {
        %0 = memref.load %alloc[%arg3, %arg4] : memref<2048x2048xf32> loc(#loc2)
