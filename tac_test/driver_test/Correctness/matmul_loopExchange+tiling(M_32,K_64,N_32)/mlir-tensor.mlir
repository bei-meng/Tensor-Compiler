    ...
    %2 = scf.for %arg2 = %c0 to %c2048 step %c64 iter_args(%arg3 = %1) -> (tensor<2048x2048xf32>) {
      %3 = scf.for %arg4 = %c0 to %c2048 step %c64 iter_args(%arg5 = %arg3) -> (tensor<2048x2048xf32>) {
        %4 = scf.for %arg6 = %c0 to %c2048 step %c64 iter_args(%arg7 = %arg5) -> (tensor<2048x2048xf32>) {
          %extracted_slice = tensor.extract_slice %arg0[%arg2, %arg4] [64, 64] [1, 1] : tensor<2048x2048xf32> to tensor<64x64xf32> loc(#loc1)
          %extracted_slice_0 = tensor.extract_slice %arg1[%arg4, %arg6] [64, 64] [1, 1] : tensor<2048x2048xf32> to tensor<64x64xf32> loc(#loc1)
          %extracted_slice_1 = tensor.extract_slice %arg7[%arg2, %arg6] [64, 64] [1, 1] : tensor<2048x2048xf32> to tensor<64x64xf32> loc(#loc1)
          %5 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "reduction", "parallel"]} ins(%extracted_slice, %extracted_slice_0 : tensor<64x64xf32>, tensor<64x64xf32>) outs(%extracted_slice_1 : tensor<64x64xf32>) {
