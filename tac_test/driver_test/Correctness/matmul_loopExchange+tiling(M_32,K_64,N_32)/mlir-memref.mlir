    ...
    scf.for %arg2 = %c0 to %c2048 step %c64 {
      scf.for %arg3 = %c0 to %c2048 step %c64 {
        scf.for %arg4 = %c0 to %c2048 step %c64 {
          %subview = memref.subview %arg0[%arg2, %arg3] [64, 64] [1, 1] : memref<2048x2048xf32, strided<[?, ?], offset: ?>> to memref<64x64xf32, strided<[?, ?], offset: ?>> loc(#loc1)
          %subview_0 = memref.subview %arg1[%arg3, %arg4] [64, 64] [1, 1] : memref<2048x2048xf32, strided<[?, ?], offset: ?>> to memref<64x64xf32, strided<[?, ?], offset: ?>> loc(#loc1)
          ...
          scf.for %arg5 = %c0 to %c64 step %c1 {
            scf.for %arg6 = %c0 to %c64 step %c1 {
              scf.for %arg7 = %c0 to %c64 step %c1 {
                %0 = memref.load %subview[%arg5, %arg6] : memref<64x64xf32, strided<[?, ?], offset: ?>> loc(#loc1)
                %1 = memref.load %subview_0[%arg6, %arg7] : memref<64x64xf32, strided<[?, ?], offset: ?>> loc(#loc1)
