    ...
    scf.for %arg2 = %c0 to %c2048 step %c1 {
      scf.for %arg3 = %c0 to %c2048 step %c1 {
        scf.for %arg4 = %c0 to %c2048 step %c1 {
          ...
          %1 = memref.load %alloc[%arg3, %arg4] : memref<2048x2048xf32> loc(#loc1)
          %2 = memref.load %alloc_0[%arg2, %arg3] : memref<2048x2048xf32> loc(#loc1)
          %3 = arith.mulf %0, %1 : f32 loc(#loc1)
          %4 = arith.addf %2, %3 : f32 loc(#loc1)
          memref.store %4, %alloc_0[%arg2, %arg3] : memref<2048x2048xf32> loc(#loc1)
        } loc(#loc1)
      } loc(#loc1)
    } loc(#loc1)
