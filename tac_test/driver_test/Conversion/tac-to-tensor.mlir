...
module {
  func.func @main() -> tensor<2xf32> attributes {llvm.emit_c_interface} {
    %0 = "tac.constant"() <{value = dense<[1.000000e+00, 2.000000e+00]> : tensor<2xf32>}> : () -> tensor<2xf32>
    %1 = "tac.constant"() <{value = dense<[3.000000e+00, 4.000000e+00]> : tensor<2xf32>}> : () -> tensor<2xf32>
