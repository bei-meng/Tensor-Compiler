...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> TensorProto_DataType_strings[29] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry TensorProto_DataType_entries[] = {
  ...
  { {TensorProto_DataType_names + 59, 10}, 27 },
  { {TensorProto_DataType_names + 69, 10}, 28 },
  { {TensorProto_DataType_names + 79, 12}, 17 },
  { {TensorProto_DataType_names + 91, 14}, 18 },
  { {TensorProto_DataType_names + 105, 10}, 19 },
  { {TensorProto_DataType_names + 115, 14}, 20 },
  { {TensorProto_DataType_names + 129, 10}, 24 },
  { {TensorProto_DataType_names + 139, 5}, 5 },
  { {TensorProto_DataType_names + 144, 4}, 26 },
  { {TensorProto_DataType_names + 148, 5}, 6 },
  { {TensorProto_DataType_names + 153, 4}, 22 },
  { {TensorProto_DataType_names + 157, 5}, 7 },
  { {TensorProto_DataType_names + 162, 4}, 3 },
  { {TensorProto_DataType_names + 166, 6}, 8 },
  { {TensorProto_DataType_names + 172, 6}, 4 },
  { {TensorProto_DataType_names + 178, 5}, 25 },
  { {TensorProto_DataType_names + 183, 6}, 12 },
  { {TensorProto_DataType_names + 189, 5}, 21 },
  { {TensorProto_DataType_names + 194, 6}, 13 },
  { {TensorProto_DataType_names + 200, 5}, 2 },
  { {TensorProto_DataType_names + 205, 9}, 0 },
};
...
static const int TensorProto_DataType_entries_by_number[] = {
  ...
  0, // 16 -> BFLOAT16
  10, // 17 -> FLOAT8E4M3FN
  11, // 18 -> FLOAT8E4M3FNUZ
  12, // 19 -> FLOAT8E5M2
  13, // 20 -> FLOAT8E5M2FNUZ
  25, // 21 -> UINT4
  18, // 22 -> INT4
  7, // 23 -> FLOAT4E2M1
  14, // 24 -> FLOAT8E8M0
...
const std::string& TensorProto_DataType_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          29, TensorProto_DataType_strings);
  (void) dummy;
  int idx = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumName(
      TensorProto_DataType_entries,
      TensorProto_DataType_entries_by_number,
...
bool TensorProto_DataType_Parse(
  ...
  int int_value;
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      TensorProto_DataType_entries, 29, name, &int_value);
  if (success) {
...
constexpr TensorProto_DataType TensorProto::FLOAT6E2M3;
constexpr TensorProto_DataType TensorProto::FLOAT6E3M2;
...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> Version_strings[15] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry Version_entries[] = {
  ...
  { {Version_names + 252, 21}, 13 },
  { {Version_names + 273, 14}, 0 },
};
...
bool Version_Parse(
  ...
  int int_value;
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      Version_entries, 15, name, &int_value);
  if (success) {
